...
Active development happens in the trunk branch, master branch is used to merge stable versions of the trunk branch.

== Shifting to MiniTest

The development branch minitest has shifted to use minitest instead of unit test.
If you are using ruby 1.9.x there's nothing you need to do about it but if you are
